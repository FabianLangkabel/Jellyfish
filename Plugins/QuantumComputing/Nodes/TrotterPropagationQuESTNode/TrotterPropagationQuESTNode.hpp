...
#include "../../Lib/header/quantum_propagation_laser_cap_quest.h"
...
class TrotterPropagationQuESTNode : public Node, public QObject
{
public:
    TrotterPropagationQuESTNode(std::string InpNodeTypeID);
    ~TrotterPropagationQuESTNode();
...
private:
    ...
    QCheckBox* use_partial_topographie_checkbox;
    bool use_partial_topographie = false;
    void set_use_partial_topographie();
};
