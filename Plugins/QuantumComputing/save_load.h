...
public:
	...
	void static save(std::string file, std::string id, std::string name, QC::Pauli_Operator data);
	void static save(std::string file, std::string id, std::string name, QC::QC_Statevector data);
	void static save(std::string file, std::string id, std::string name, QC::QC_TD_Statevectors data);
	void static save(std::string file, std::string id, std::string name, QC::QC_TD_Norm data);
	...
	void static load(std::string file, std::string id, std::string name, QC::Pauli_Operator* object);
	void static load(std::string file, std::string id, std::string name, QC::QC_Statevector* object);
	void static load(std::string file, std::string id, std::string name, QC::QC_TD_Statevectors* object);
	void static load(std::string file, std::string id, std::string name, QC::QC_TD_Norm* object);
