...
void save_load::load(std::string file, std::string id, std::string name, QC::Pauli_Operator* object)
{
    std::string filecontent = read_single_file(file, id, name);
    std::istringstream iss(filecontent);
    std::string line;
...
void save_load::load(std::string file, std::string id, std::string name, QC::QC_Statevector* object)
{
    std::string filecontent = read_single_file(file, id, name);
    std::istringstream iss(filecontent);
    std::string line;
...
void save_load::load(std::string file, std::string id, std::string name, QC::QC_TD_Statevectors* object)
{
    std::string filecontent = read_single_file(file, id, name);
    std::istringstream iss(filecontent);
    std::string line;
...
void save_load::load(std::string file, std::string id, std::string name, QC::QC_TD_Norm* object)
{
    std::string filecontent = read_single_file(file, id, name);
    std::istringstream iss(filecontent);
    std::string line;
...
void save_load::save(std::string file, std::string id, std::string name, QC::Pauli_Operator data)
{
    std::ostringstream outStream;
...
void save_load::save(std::string file, std::string id, std::string name, QC::QC_Statevector data)
{
    std::ostringstream outStream;
...
void save_load::save(std::string file, std::string id, std::string name, QC::QC_TD_Statevectors data)
{
    std::ostringstream outStream;
...
void save_load::save(std::string file, std::string id, std::string name, QC::QC_TD_Norm data)
{
    std::ostringstream outStream;
    std::vector<double> times = data.get_times();
