...
#include "Nodes/PlotCINewNode/PlotCINewNode.hpp"
#include "Nodes/PlotTDCINewNode/PlotTDCINewNode.hpp"
...
// our class plugin
class pluginvisualization final : public micro::iplugin<>, public std::enable_shared_from_this<pluginvisualization> {
public:

  plugin_node_manager* NodeManager;
  json plugin_infos;

  pluginvisualization(int v, const std::string& nm):micro::iplugin<>(v, nm), std::enable_shared_from_this<pluginvisualization>() {
    ...
    NodeManager->RegisteredNodes->registerClass<PlotCINewNode>("PlotCINewNode");
    NodeManager->RegisteredNodes->registerClass<PlotTDCINewNode>("PlotTDCINewNode");
    ...
    subscribe<0>("GetPluginInfos", std::bind(&pluginvisualization::GetPluginInfos, this));
  }

  ~pluginvisualization() override {}
...
static std::shared_ptr<pluginvisualization> instance = nullptr;
...
std::shared_ptr<micro::iplugin<>> import_plugin() {
  ...
  return instance ? instance : (instance = std::make_shared<pluginvisualization>(plugin_version, "Visualization"));
}